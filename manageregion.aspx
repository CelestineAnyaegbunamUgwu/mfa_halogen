<%@ Page Language="vb" AutoEventWireup="false" Debug ="true"  CodeFile="manageregion.aspx.vb" Inherits="manageregion" %>
      ...
      <div class="container">
          ...
          <div class="col-md-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-bars"></i>  - Manage Regions</li>
...
<div class = "breadcrumbs">
    ...
    <span class="input-group-addon"><i class="fa fa-home"></i></span>
                                            <asp:TextBox ID="txtRegionName" runat="server" placeholder="Name of Region" class="form-control input-sm"></asp:TextBox>
                                        </div>
                                        
                                        <br /> <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
                                            <asp:TextBox ID="txtRemarks" runat="server" placeholder="Remarks" class="form-control input-sm"></asp:TextBox>
                                        </div><br />
                                                                              <div class="form-group">
