<%@ Page Language="vb" AutoEventWireup="false" Debug ="true"  CodeFile="changepassword.aspx.vb" Inherits="changepassword" %>
...
<head runat="server">
  ...
  <title>S3 Change Account Password</title>
      ...
      <div class="container">
          ...
          <div class="col-md-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-bars"></i>  - Change Account Password</li>
...
<div class = "breadcrumbs">
    ...
    <span class="input-group-addon"><i class="fa fa-home"></i></span>
                                            <asp:TextBox ID="txtoldpassword" runat="server" placeholder="Enter Old Password" class="form-control input-sm" TextMode="Password"></asp:TextBox>
                                       
            </div>
                                        <br /> <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
                                            <asp:TextBox ID="txtNewPassword" runat="server" placeholder="Enter New Password" class="form-control input-sm" TextMode="Password"></asp:TextBox>
                                        </div>
                                        <br /> <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                                            <asp:TextBox ID="txtRepeatNewPassword" runat="server" placeholder="Repeat New Password" class="form-control input-sm" TextMode="Password"></asp:TextBox>
                                        </div>
                                    <br />                                 
                                                                            <div class="form-group">
                                           <asp:Button ID="btnUpdate" class="btn btn-secondary btn-sm" runat="server" Text="Update"  />&nbsp;
                                           <asp:Button ID="Btnclear" class="btn btn-primary btn-sm" runat="server" Text="Clear"  />&nbsp;
