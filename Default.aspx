<%@ Page Language="vb" AutoEventWireup="false" Debug ="true"  CodeFile="Default.aspx.vb" Inherits="Default" %>
...
<body>
  ...
  <main id="main">
   ...
   <div class="row">
        ...
        <p >This is a design implementation of Halogen Group Secured Software Sandbox (S3), with multifactor authentication (MFA) concept. 
        <br />S3 provides Halogen Group with the possibility of assembling all the software solutions they use in-house in a single portal called SANDBOX, so that the management can easily monitor 
            the use of the applications by staff from anywhere.
             </p>   
            <p>
                The main objective of this project is show how to implement MFA when trying to access S3.
            </p>
