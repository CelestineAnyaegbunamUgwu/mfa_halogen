<%@ Page Language="vb" AutoEventWireup="false" Debug ="true"  CodeFile="managedept.aspx.vb" Inherits="managedept" %>
...
<head runat="server">
  ...
  <title>S3 Manage Departments</title>
      ...
      <div class="container">
          ...
          <div class="col-md-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-bars"></i>  - Manage Departments</li>
...
<div class = "breadcrumbs">
    ...
    <span class="input-group-addon"><i class="fa fa-home"></i></span>
                                            <asp:TextBox ID="txtnUserName" runat="server" placeholder="Name of Department" class="form-control input-sm"></asp:TextBox>
                                        </div>
                                        
                                        <br /> <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
                                            <asp:TextBox ID="txtemail" runat="server" placeholder="Dept General Email" class="form-control input-sm"></asp:TextBox>
                                        </div>
                                        <br /> <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                                            <asp:TextBox ID="txtphone" runat="server" placeholder="Dept General Phone" class="form-control input-sm"></asp:TextBox>
                                        </div>
...
<br />
                                ...
                                <!-- /.col-lg-6 (nested) --><div class="col-lg-8">
                                        ...
                                        <asp:GridView ID="GridUser" class="table table-striped table-bordered table-hover" runat="server" Font-Size="8pt" AutoGenerateSelectButton="false">
                                           <Columns>
