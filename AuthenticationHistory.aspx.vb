Public Class AuthenticationHistory
    ...
    Private Sub srcDelete()
        ...
        Dim xFields As String = "Id as [Id], Username as [User Name], nTime as [Date Time],emailCode as [Email Code],smsCode as [SMS Code],Device as [Device Used],LocationIP as [ISP IP],Browser,BranchCode as [Branch],Status"
