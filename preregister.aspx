...
<div class = "breadcrumbs">
    ...
    <span class="input-group-addon"><i class="fa fa-user"></i></span>
     <asp:TextBox ID="txtnUserName" runat="server" placeholder="Enter your company email" class="form-control input-sm" TextMode="Email"></asp:TextBox>
  </div>
                                       <br /> <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                            <asp:TextBox ID="txtPwd" runat="server" placeholder="Set your preferred password." class="form-control input-sm"></asp:TextBox>
                                        </div>
                                        <br /> <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-user-md"></i></span>
                                            <asp:TextBox ID="txtfullname" runat="server" placeholder="Your Full Name" class="form-control input-sm"></asp:TextBox>
                                        </div>
                                        
                                    <br /> <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                                            <asp:TextBox ID="txtphone" runat="server" placeholder="Mobile Phone Number" class="form-control input-sm"></asp:TextBox>
                                        </div>
    ...
    <span class="input-group-addon"><i class="fa fa-crosshairs"></i></span>
                                            <asp:TextBox ID="txtOfficeAddress" runat="server" placeholder="Your Office Room Address" class="form-control input-sm"></asp:TextBox>
                                        </div><br />
                                      <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-th"></i></span>
                                            <asp:TextBox ID="txtResidentialAddress" runat="server" placeholder="Your Residential Address" class="form-control input-sm"></asp:TextBox>
                                        </div>
                                        
                                       <br />
                                    <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-phone"></i>Select your branch code</span>
                                                    <asp:Dropdownlist ID="Dropbranchcode" runat="server" class="form-control input-sm" Visible="True"></asp:Dropdownlist>
</div><br />
                                   <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-phone"></i>Select your department</span>
                                            <asp:Dropdownlist ID="dropdept" runat="server" placeholder="User's Department" class="form-control input-sm" Visible="True"></asp:Dropdownlist>
                                        </div><br />
